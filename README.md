...
No framework, no database, no message queue. Just Python and one optional dependency.

Tested and working in Immich v2.6.2 (Mar 25 2026)
...
Add to **System → Advanced → Init/Shutdown Scripts** as a **Post Init** command:
